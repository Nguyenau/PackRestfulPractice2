...
# default for pagination: http://127.0.0.1:8000/drones/?limit=4&offset=4 same as http://127.0.0.1:8000/drones/
# eg: http://127.0.0.1:8000/drones/?drone_category=1&has_it_competed=False&ordering=-name&search=G
...
# eg1: http://127.0.0.1:8000/competitions/?pilot_name=Penelope Pitstop&drone_name=WonderDrone
# eg2: http:// 127.0.0.1:8000/competitions/?from_achievement_date=2017-10-18&to_achievement_date=2017-10-21&min_distance_in_feet=700&max_distance_in_feet=900 
# Still use Basic Auth for login user, NOT Authorization Token
